...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var nuevoarray=array.map((num) => num +1)
   return nuevoarray;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   let sumaDeNotas= resultadosTest.length
   let resultados= resultadosTest.reduce((acumulador,elemento)=> acumulador+elemento,0)
   return resultados/sumaDeNotas;
}
